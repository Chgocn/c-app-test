...
public class CustomErrorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //CrashHandler.getStackTraceFromIntent(getIntent()): gets the stack trace as a string
        //CrashHandler.getAllErrorDetailsFromIntent(context, getIntent()): returns all error details including stacktrace as a string
        //CrashHandler.getRestartActivityClassFromIntent(getIntent()): returns the class of the restart activity to launch, or null if none
        //CrashHandler.getEventListenerFromIntent(getIntent()): returns the event listener that must be passed to restartApplicationWithIntent or closeApplication
        ...
        errorDetailsText.setText(CrashHandler.getStackTraceFromIntent(getIntent()));
        ...
        if (restartActivityClass != null) {
            ...
            restartButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    CrashHandler.restartApplicationWithIntent(CustomErrorActivity.this, intent, eventListener);
                }
            });
        } else {
            restartButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    CrashHandler.closeApplication(CustomErrorActivity.this, eventListener);
                }
            });
        }
    }
