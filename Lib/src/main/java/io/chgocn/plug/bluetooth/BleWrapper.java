package io.chgocn.plug.bluetooth;
...
public class BleWrapper {
     ...
     * @param callback
     */
    public BleWrapper(Activity activity, BleWrapperUiCallbacks callback) {
    ...
    /**
     * before any action check if bluetooth is turned on and enabled for us
	 * call this in onResume to be always sure that bluetooth is on when Your
    ...
    public boolean connect(final String deviceAddress) {
        ...
        if(mBluetoothGatt != null && mBluetoothGatt.getDevice().getAddress().equals(deviceAddress)) {
        	...
        	mBluetoothGatt = mBluetoothDevice.connectGatt(mActivity, false, mBleCallback);
        }
        return true;
    }  
