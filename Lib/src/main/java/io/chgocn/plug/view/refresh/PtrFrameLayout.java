...
import io.chgocn.plug.view.refresh.indicator.PtrIndicator;
import io.chgocn.plug.view.refresh.util.PtrCLog;
 ...
 * It defines {@link io.chgocn.plug.view.refresh.PtrUIHandler}, which allows you customize the UI easily.
 */
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mDisableWhenHorizontalMove && Math.abs(offsetX) > Math.abs(offsetY)) {
                    return dispatchTouchEventSupper(e);
                }
